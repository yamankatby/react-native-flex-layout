...
<Head>
  <title>Selector | React Native Flex Layout</title>
  <meta
    name="description"
    content="A wrapper component that can be used to apply a style to a subset of its children."
  />
</Head>
...
[`💬 Feedback`](https://github.com/yamankatby/react-native-flex-layout/labels/selector) , [`🌱 Source`](https://github.com/yamankatby/react-native-flex-layout/blob/main/src/Selector.tsx)
