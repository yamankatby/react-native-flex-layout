...
<Head>
  <title>Flex | React Native Flex Layout</title>
  <meta
    name="description"
    content="Flex is a container view extends React Native's flex-box properties and comes with helpful style shorthands."
  />
</Head>
...
[`💬 Feedback`](https://github.com/yamankatby/react-native-flex-layout/labels/flex) , [`🌱 Source`](https://github.com/yamankatby/react-native-flex-layout/blob/main/src/Flex.tsx)
