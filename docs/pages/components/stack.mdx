...
<Head>
  <title>Stack | React Native Flex Layout</title>
  <meta
    name="description"
    content="Stack is a layout component that makes it easy to stack elements together and apply a space between them."
  />
</Head>
